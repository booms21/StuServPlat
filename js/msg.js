...
EventUtil.addLoadHandler(function ()
{
	...
	function fnSend ()
	{
		...
		if(reg.test(oUserName))
		{
			alert("\u8bf7\u586b\u5199\u60a8\u7684\u59d3\u540d");
			oUserName.focus()
		}
		else if(!/^[u4e00-\u9fa5\w]{2,8}$/g.test(oUserName))
		{
		...
		else
		{
			...
			var oDate = new Date();
			oLi.innerHTML = "<div class=\"userPic\"><img src=\"../img/user.png\"></div>\
							 <div class=\"content\">\
							 	<div class=\"userName\"><a href=\"javascript:;\">" + oUserName + "</a>:</div>\
